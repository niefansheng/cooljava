		...
		<div class="sysNotice col">
			...
			<table class="layui-table">
				...
				<tbody>
					...
					<tr>
						<td>服务器环境</td>
						<td class="server">Linux或Window + Tomcat 8.0 + MySQL5.7</td>
					</tr>
					<tr>
						<td>官网地址</td>
						<td class="dataBase"><a href="https://www.github.com" target="_blank">https://www.github.com</a></td>
					</tr>
